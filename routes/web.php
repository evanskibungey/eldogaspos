...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware(['role:admin'])->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::prefix('stock')->name('stock.')->group(function () {
            ...
            Route::post('/adjust-stock', [StockMovementController::class, 'adjustStock'])->name('adjust');
        });
    ...
    Route::middleware(['admin.or.cashier'])->prefix('pos')->name('pos.')->group(function () {
        ...
        // Debug route
        Route::post('/debug-sale', [PosController::class, 'debugSale'])->name('pos.debug-sale');
    });
});
