                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative">
                                       <select name="cylinder_type" id="cylinder_type" required
                                                class="w-full px-4 py-4 border-2 border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-orange-500 focus:border-orange-500 bg-white appearance-none font-medium">
                                            <option value="">Select type...</option>
                                            <option value="Total Gas" {{ old('cylinder_type') === 'Total Gas' ? 'selected' : '' }}>Total Gas</option>
                                            <option value="K-Gas" {{ old('cylinder_type') === 'K-Gas' ? 'selected' : '' }}>K-Gas</option>
                                            <option value="Pro Gas" {{ old('cylinder_type') === 'Pro Gas' ? 'selected' : '' }}>Pro Gas</option>
                                            <option value="Afrigas" {{ old('cylinder_type') === 'Afrigas' ? 'selected' : '' }}>Afrigas</option>
                                            <option value="Hashi Gas" {{ old('cylinder_type') === 'Hashi Gas' ? 'selected' : '' }}>Hashi Gas</option>
                                            <option value="Sea Gas" {{ old('cylinder_type') === 'Sea Gas' ? 'selected' : '' }}>Sea Gas</option>
                                            <option value="Supa Gas" {{ old('cylinder_type') === 'Supa Gas' ? 'selected' : '' }}>Supa Gas</option>
                                            <option value="Ola Gas" {{ old('cylinder_type') === 'Ola Gas' ? 'selected' : '' }}>Ola Gas</option>
                                            <option value="Dalbit Gas" {{ old('cylinder_type') === 'Dalbit Gas' ? 'selected' : '' }}>Dalbit Gas</option>
                                            <option value="Mwanga Gas" {{ old('cylinder_type') === 'Mwanga Gas' ? 'selected' : '' }}>Mwanga Gas</option>
                                            <option value="Power Gas" {{ old('cylinder_type') === 'Power Gas' ? 'selected' : '' }}>Power Gas</option>
                                            <option value="Hass Gas" {{ old('cylinder_type') === 'Hass Gas' ? 'selected' : '' }}>Hass Gas</option>
                                            <option value="Top Gas" {{ old('cylinder_type') === 'Top Gas' ? 'selected' : '' }}>Top Gas</option>
                                            <option value="Mpishi Gas" {{ old('cylinder_type') === 'Mpishi Gas' ? 'selected' : '' }}>Mpishi Gas</option>
                                            <option value="E-Gas" {{ old('cylinder_type') === 'E-Gas' ? 'selected' : '' }}>E-Gas</option>
                                            <option value="Taifa Gas" {{ old('cylinder_type') === 'Taifa Gas' ? 'selected' : '' }}>Taifa Gas</option>
                                        </select>
                                        <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                                            <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
